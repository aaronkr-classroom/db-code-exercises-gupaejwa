...
VALUES
	...
	('박지선', 'AI공학', 70000, 2, '2001-3-1'),
	('이재삭', '정보통신공학', 80000, 2, '2003-4-1'),
	('류현지', '간호학', 90000, 2, '2004-4-14'),
	('양정호', '소프트웨어학', 100000, 2, '1998-12-31'
...
SELECT name, salary FROM prof WHERE name LIKE '김%'; --PostgreSQL ILIKE 대/소문자 상관없이
